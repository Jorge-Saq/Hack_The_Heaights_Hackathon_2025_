            ...
            >
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-gray-900">Upload Crowd Photos</h3>
                    <p className="text-sm text-gray-500">Upload event photos to find and notify people</p>
                  </div>
                </div>
              </div>
            </Link>
